...
import {
    ...
    HStack, Heading, Text, Checkbox, Select, Flex, Button, VStack, Image, AspectRatio
        ...
        <div>
            ...
            >
                ...
                <Box mt={'40px'}  >
                    ...
                    <div style={{ "border-radius": "3px", "width": "52.3%", 'margin-top': "30px"}} id="BlockLossCodeAjax"> <select name="LossCode" multiple="" size="20" class="Task17098_select">
                ...
                >
                    <Box flex="1">
                        <HStack justifyContent='center'>
                            <Heading color='#2347F0' fontSize='4xl'>Client Search</Heading>
                        </HStack>
                    </Box>
